...
void Pub::Game_Initialize()
{
	...
	loadimage(&bk0, _T("res/background0.png"), 1080, 720);
	loadimage(&bk2, _T("res/background3.jpg"), 560, 720);
	loadimage(&bk4, _T("res/background6.png"), 720, 720);
...
void Pub::PS(int sound)
{
	...
	{
	case 0:
		PlaySound("res/start.wav", NULL, SND_ASYNC);
		break;
	case 1:
		PlaySound("res/move.wav", NULL, SND_ASYNC);
		break;
	case 2:
		PlaySound("res/kendiao.wav", NULL, SND_ASYNC);
		break;
	case 3:
		PlaySound("res/zhuangsi.wav", NULL, SND_ASYNC);
		break;
	case 4:
		PlaySound("res/doumei.wav", NULL, SND_ASYNC);
		break;
	case 5:
		PlaySound("res/end.wav", NULL, SND_ASYNC);
		break;
	case 6:
		PlaySound("res/dead.wav", NULL, SND_ASYNC);
		break;
	}
